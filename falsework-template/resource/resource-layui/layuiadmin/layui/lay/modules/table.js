...
layui.define(["laytpl", "laypage", "layer", "form"], function(e) {
	...
	S.prototype.config = {
		...
		if (a.startTime = (new Date).getTime(), n.url) {
			var c = {};
			c[o.pageName] = n.pageBegin == 0 ? e - 1 : e, c[o.limitName] = n.limit;
			var co = {};
			// co[n.pageObjName || "page"] = c;
			co = c;//适配request
			t.ajax({
				type: n.method || "get",
				url: n.url,
				data: ((n.contentType && n.contentType.indexOf('application/json') > -1) && JSON.stringify(t.extend(co, n.where))) || t.extend(co, n.where),
				contentType: n.contentType || "application/x-www-form-urlencoded;charset=UTF-8",
				dataType: "json",
				success: function(t) {
					//适配response
					if (t.data) {
						t[r.countName] = t.data[r.countName];
						t[r.dataName] = t.data[r.dataName];
						t.data = null
					}
